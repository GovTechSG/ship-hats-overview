...
<kbd>![view-all-users-blurred](images/view-all-users-blurred.png ':size=75%')</kbd>
...
<kbd>![remove_user_cropped_blurred](images/remove-user-cropped-blurred.png ':size=75%')</kbd>
