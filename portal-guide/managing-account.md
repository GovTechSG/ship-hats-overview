...
<kbd>![view-and-update-profile-user-role-and-name-blurred](images/view-and-update-profile-user-role-and-name-blurred.png)</kbd>
...
<kbd>![edit-profile-details-blurred](images/edit-profile-details-blurred.png)</kbd>
...
<kbd>![edit-profile-normal-users-blurred](images/edit-profile-normal-users-blurred.png)</kbd>
...
<kbd>![change-pwd-user](images/change-password-user.png)</kbd>

The **Change Password** page is displayed.

<kbd>![change-pwd](images/change-pwd.png)</kbd>
...
<kbd>![reset-pwd-login-page-1](images/reset-pwd-login-page-1.png)</kbd>

3. Click the link indicated in the above image to reset your password. You will be directed to the **Self-help Requests** page.

<kbd>![retrieve-username-self-help-page](images/retrieve-username-self-help-page.png)</kbd>
...
<kbd>![retreive-username-request-success-1.png](images/retreive-username-request-success-1.png)</kbd>
...
<kbd>![reset-pwd-self-help-page](images/reset-pwd-self-help-page.png)</kbd>
...
<kbd>![reset-pwd-link-request-success](images/reset-pwd-link-request-success.png)</kbd>
...
<kbd>![reset-2fa-self-help-page](images/reset-2fa-self-help-page.png)</kbd>

4. Click **Reset 2FA**.
5. Enter your **Username** used for** registering with SHIP-HATS.
6. Select the checkbox to confirm that you are not a robot and click **Submit**.

<kbd>![2fa-reset-request-success](images/2fa-reset-request-success.png)</kbd>
...
<kbd>![plan-details](images/plan-details.png)</kbd>
...
<kbd>![plan-details](images/plan-details-1.png)</kbd>
...
<kbd>![view-subscription-details-for-other-users](images/view-subscription-details-for-other-users.png)</kbd>
...
<kbd>![billing-info-menu](images/billing-info-menu.png)</kbd>

This page has three sections: Billing Information, Approver Information and Signed Service Sheets (SS).

**Billing Information**

<kbd>![billing-information](images/billing-information.png)</kbd>
...
<kbd>![approver-information](images/approver-information.png)</kbd>

**Signed Service Sheets(SS)**

You can find the signed service sheets for this account.

<kbd>![signed-service-sheet](images/signed-ss.png)</kbd>
