...
2. Click **View** corresponding to that alert. You will be directed to the **Pending Approval** section.
   ...
   >**Note:** If there is a number displayed beside the **All Users** menu and **Pending Approval** section, it indicates that many user approvals are pending.  

   <br /><kbd>![add user](images/tp-add-user.png ':size=100%')</kbd>
